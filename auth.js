const authI18n = {
  tr: {
    ...
    errorDiscordConfig: "Discord ayarlari eksik. .env icindeki Client ID ve Secret kontrol edilmeli.",
    ...
    errorDiscordRedirect: "Discord Redirect URI uyusmuyor. .env ve Discord Developer Portal adresi birebir ayni olmali.",
  ...
  en: {
    ...
    errorDiscordConfig: "Discord settings are missing. Check Client ID and Secret in .env.",
    ...
    errorDiscordRedirect: "Discord Redirect URI does not match. The .env and Discord Developer Portal addresses must be identical.",
  ...
  ru: {
    ...
    errorDiscordConfig: "Nastroyki Discord otsutstvuyut. Proverte Client ID i Secret v .env.",
    ...
    errorDiscordRedirect: "Discord Redirect URI ne sovpadaet. Adresa v .env i Discord Developer Portal dolzhny sovpadat.",
